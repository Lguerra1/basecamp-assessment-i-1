...
// #4 Using the previously created variables, create a new variable called 'me' that uses the myName and faveNum variable to create a sentence like this 'My name is Bryan and my favorite number is 3'
